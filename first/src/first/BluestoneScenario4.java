...
public class BluestoneScenario4 {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			for(int newcost:newprice)
			{
				if(newcost>10000)
				{
				System.out.println(newcost+" Prive is greater than 10000");
				}
				else
				{
				System.out.println(newcost+" price is below 10000");
				}
			}
			driver.close();
