...
public class BluePendant{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int listofcost:newcostList)
		{
			if(listofcost>10000&&listofcost<15000)
			{
			System.out.println(listofcost+"Price is greater than 10000 and below 15000");
			}
			else
			{
			System.out.println(listofcost+"price is below 10000");
			}
		}
